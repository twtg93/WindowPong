...
var play = function()
{
	...
	if( !pla1 || pla1.closed ) pla1 = window.open( "/windowpong/player1.html", "Player1", "top="+ py +",left="+ px +",width="+ w +",height="+ h +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );
	if( !pla2 || pla2.closed ) pla2 = window.open( "/windowpong/player2.html", "Player2", "top="+ py +",left="+ px +",width="+ w +",height="+ h +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );

	var bx = Math.round( screen.width  / 2 - unit / 2 );
	var by = Math.round( screen.height / 2 - unit / 2 );
	if( !ball || ball.closed ) ball = window.open( "/windowpong/ball.html", "Ball", "top="+ by +",left="+ bx +",width="+ unit +",height="+ unit +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );
...
var victory = function( i )
{
	...
	if( !vict ||  vict.closed ) vict = window.open( "/windowpong/victory"+ i +".html", "Victory", "top="+ y +",left="+ x +",width="+ w +",height="+ h +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );
	if(  vict && !vict.closed )
	{
...
var about = function()
{
	...
	var x = Math.round( screen.width  / 2 - w / 2 );
	var y = Math.round( screen.height / 2 - h / 2 );
	if( !info ||  info.closed ) info = window.open( "/windowpong/about.html", "About", "top="+ y +",left="+ x +",width="+ w +",height="+ h +",location=no,menubar=no,scrollbars=yes,status=no,toolbar=no" );
	if(  info && !info.closed )
	{
